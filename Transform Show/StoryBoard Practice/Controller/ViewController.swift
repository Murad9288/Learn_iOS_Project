...
//  StoryBoard Practice
//
//  Created by Md Murad Hossain on 1/9/22.
//
   ...
   // MARK: Click Button Action
    ...
    private func transformImage(){
        ...
        case 1:
            ...
            imageView2.transform = CGAffineTransform(translationX: 0, y: -80)
            view1.transform = CGAffineTransform(translationX: 0, y: 40)
        ...
        case 3:
            imageView.transform = CGAffineTransform(translationX: -55, y: -238)
            imageView2.transform = CGAffineTransform(translationX: 55, y: 300)
           // clickButton1.transform = CGAffineTransform(translationX: 0, y: 40)
